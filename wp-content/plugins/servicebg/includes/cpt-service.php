...
* OOP Part
*/
if ( ! class_exists( 'Servicebg_Services' ) ) :

	class Servicebg_Services {
		public function __construct() {
			add_action( 'init', array( $this, 'servicebg_register_service_cpt' ) );
		}
...
$servicebg_services = new Servicebg_Services();
